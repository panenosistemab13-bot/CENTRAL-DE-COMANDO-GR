...
const menuItems: MenuItem[] = [
  ...
  { id: 'sm_creator', label: 'SM', buttonLabel: 'Eventos', icon: CalendarDays, color: 'from-rose-500 to-pink-700', description: 'Criação e agendamento de solicitações de monitoramento.' },
