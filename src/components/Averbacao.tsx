          ...
          <div className="lg:col-span-1 space-y-6">
            <div className="report-card p-6">
              <div className="flex items-center justify-between mb-6">
                <h3 className="text-sm font-bold text-white uppercase tracking-tight">Dados Complementares</h3>
               ...
               <div className="flex items-start gap-4">
                 ...
                 <div>
                   ...
                   <p className="text-[10px] text-slate-400 leading-relaxed">
                     Verifique se as placas estão corretas antes de enviar o e-mail. O protocolo 105 é referente à segunda carreta.
                   </p>
                 </div>
               </div>
            </div>
